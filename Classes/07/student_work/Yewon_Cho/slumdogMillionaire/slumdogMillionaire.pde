...
void draw(){
  ...
  if (questionIndex > 4){
    ...
    text(answerChoices[questionIndex][0], x, 400);
    fill(0);
    text(answerChoices[questionIndex][1], x + 200, 400);
    fill(0);
    text(answerChoices[questionIndex][2], x + 400, 400);
    fill(0);
    text(answerChoices[questionIndex][3], x + 600, 400);
    fill(0);
