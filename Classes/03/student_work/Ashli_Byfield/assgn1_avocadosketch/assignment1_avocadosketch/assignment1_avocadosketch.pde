...
//now im just layering to try and represent all the different colors of the nut
  ...
  ellipse(520,440,85,100); 
}

save("assgn1_avocadosketch.png");

//note: i still need help with positioning the different ellipses of my sketch; right now just applying a guess and check method
