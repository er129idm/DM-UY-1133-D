...
String[] points = {"1", "5", "10", "15", "20", "25"}; // the total amount of points scored 
...
String[] names2 = {"Russell Westbrook", "James Harden", "Giannis Antetokounmpo", "Paul George"}; // 
void setup() {
}
...
void draw(){
  ...
  delay(1000); // adding delay for better readability 
  ...
  println("They are split up into two separate teams."); // creating a line of text for the story  
  ...
  String randomScored2 = randomScored + 1;
  
  println(randomNames + " just scored " + randomScored + " points, he has scored " + randomPoints + " points this game");
  println(randomNames2 + " has scored " + randomScored2 + " points this game");
  }
