...
void wolfBattle() {
  int wolfHealth = int(random(50, 70)); 
      ...
      println("Hero attacks Wolf for " + heroAttack);
      delay (2500);
      println(".........");
      delay (2000);
      ...
      while(wolfHealth > 0) {
        ...
        println(".........");
        delay (2000);
        println("Wolf attacks Hero for " + wolfAttack);
        delay (2500);
        println(".........");
        delay (2000);
...
void spiderBattle() {
  int spiderHealth = int(random(30, 51)); 
      ...
      println("Hero attacks Spider for " + heroAttack);
      delay (2500);
      println(".........");
      delay (2000);
      ...
      while(spiderHealth > 0) {
        ...
        println(".........");
        delay (2000);
        println("Spider attacks Hero for " + spiderAttack);
        delay (2500);
        println(".........");
        delay (2000);
