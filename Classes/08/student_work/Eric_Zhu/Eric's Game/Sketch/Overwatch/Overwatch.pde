...
Boolean heroChoose=false;
float ultimateCharge=0;
...
void setup() {
  ...
  rectMode(CENTER);
  noStroke();
  DJ=loadImage("DJhero1.png");
  Background1=loadImage("IMG_4219.jpg");
  Title=loadImage("IMG_4220.JPG");
  TitleDJ=loadImage("IMG_4224.JPG");
  TitleMei=loadImage("IMG_4223.JPG");
  TitleDva=loadImage("IMG_4232.JPG");
  TitlePharah=loadImage("IMG_4222.JPG");
  TitleReaper=loadImage("IMG_4230.JPG");
  TitleMccree=loadImage("IMG_4231.JPG");
...
void draw() {
  if (title) {
    image(Title, 540, 540, 540, 540);
    textSize(40);
    fill(200);
    text("Press 'Q' To Start", 700, 1000);
  }
  ...
  if (heroChoose) {
    ...
    textSize(70);
    fill(250);
    text("Choose Your Hero...", 70, 300);
    textSize(30);
    fill(59, 242, 11);
    image(TitleDJ, 250, 800, 200, 200);
    text("Press 4", 180, 920);

    fill(102, 201, 232);
    image(TitleMei, 550, 800, 200, 200);
    text("Press 5", 480, 920);

    fill(10);
    image(TitleReaper, 850, 800, 200, 200);
    text("Press 6", 780, 920);

    fill(232, 193, 220);
    image(TitleDva, 150, 500, 200, 200);
    text("Press 1", 150, 650);

    fill(154, 55, 49);  
    image(TitleMccree, 450, 500, 200, 200);
    text("Press 2", 450, 650);

    fill(201, 147, 18);
    image(TitlePharah, 750, 500, 200, 200);
    text("Press 3", 750, 650);
  }
  ...
  if (heroDJ) {
    float bulletYPosition=yPosition+20;
    title=false;
    background(170);
    ...
    image(DJ, xPosition, yPosition, 160, 160);
    noStroke();
    rectMode(CORNER);
    textSize(20);
    fill(200, 0, 0);
    ...
    for (int i=0; i<2; i++) {
      if (monsterAIsAlive) {
       Atouchwalls();
        ...
        AmonsterXPosition=AmonsterXPosition+random(-10, 10)+1;
        AmonsterYPosition=AmonsterYPosition+random(-15, 15);
      }
    }
    //Monster B
    for (int i=0; i<2; i++) {
      if (monsterBIsAlive) {
        ...
        BmonsterXPosition=BmonsterXPosition+random(-10, 10)-2;
        BmonsterYPosition=BmonsterYPosition+random(-15, 15);
      }
    }
    ...
    for (int i=0; i<2; i++) {
      if (monsterCIsAlive) {
        ...
        CmonsterXPosition=CmonsterXPosition+random(-10, 10)-3;
        CmonsterYPosition=CmonsterYPosition+random(-15, 15);
      }
    }
    ...
    for (int i=0; i<2; i++) {
      ...
      Dtouchwalls();
        ...
        DmonsterXPosition=DmonsterXPosition+random(-10, 10)-1;
        DmonsterYPosition=DmonsterYPosition+random(-15, 15);
      }
    }
    //Monster E
    for (int i=0; i<2; i++) {
      if (monsterEIsAlive) {
        ...
        EmonsterXPosition=EmonsterXPosition+random(-10, 10)+1;
        EmonsterYPosition=EmonsterYPosition+random(-15, 15);
      }
    }
    ...
    //DJ's attack mode
    if (jIsHeld) {
      if (bulletPosition >= xPosition+300) {
        bulletPosition=xPosition+50;
      }
      noFill();
      stroke(170, 205, 100);
      strokeWeight(2);
      ellipse(bulletPosition, bulletYPosition, 20, 30);
      stroke(180, 220, 110);
      ellipse(bulletPosition+20, bulletYPosition, 20, 50);
      stroke(170, 205, 100);
      ellipse(bulletPosition+40, bulletYPosition, 20, 70);
